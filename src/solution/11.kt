...
class Day11(input: List<String>) {
    ...
    private val galaxies = grid.filter { it.value == Data.STAR }.map { it.key }.sortedBy { it.line }
    ...
    private fun calculateShortestPath(from: Pos, to: Pos): Long {
        val rowsTraversed = (0..maxOf(from.line, to.line)) - (0..minOf(from.line, from.line))
